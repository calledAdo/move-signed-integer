...
public fun from_u64(magnitude: u64): Int64 {
    try_from_u64(magnitude).extract()
}

public fun try_from_u64(magnitude: u64): Option<Int64> {
...
public fun to_u64(a: Int64): u64 {
    try_to_u64(a).extract()
}

public fun try_to_u64(a: Int64): Option<u64> {
...
public fun raw_bits(a: Int64): u64 {
    return a.rep
}
...
public fun abs(a: &Int64): Int64 {
    assert!(a.rep != MIN_NEGATIVE_INT64, OutofBoundError);
...
fun safe_multiply_polar(a: u64, b: u64): bool {
    return MIN_NEGATIVE_INT64 / a >= b
}
...
fun safe_add_neg(a: u64, b: u64): bool {
    return MIN_NEGATIVE_INT64 - a >= b
}
